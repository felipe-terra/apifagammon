...
export class PlaceConfiguration1742043299949 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "place_configurations" ADD CONSTRAINT "FK_3880be9696b4ead3c2dac556a0c" FOREIGN KEY ("id_place") REFERENCES "places"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
